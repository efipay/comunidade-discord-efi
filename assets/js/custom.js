...
/**
 * Consulta o número de membros da comunidade no Discord
 */
fetch('https://discord.com/api/v9/invites/ptGHMtczcV?with_counts=true&with_expiration=false')
    .then((response) => response.json())
    .then((data) => {
        document.getElementById('membros').innerHTML = data.approximate_member_count;
    });
